...
const SelfIntroduction = () => {
  return (
    <div className="mb-20 lg:flex">
      <div className="mt-10 mb-10 lg:mt-20 md:ml-10 md:mr-20 lg:flex-none">
        <CoverImage
          title={title}
          src="/assets/profile/yadon-image.png"
          className="w-60 h-full mx-auto rounded-full object-cover"
          width={1300}
          height={630}
        />
      </div>
      <div className="lg:mt-20 lg:w-96 lg:flex-1 text-xl lg:text-2xl">
        <h3 className="my-3">
